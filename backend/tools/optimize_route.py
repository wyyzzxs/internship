"""optimize_route 工具 - 真实版(贪心 TSP,本轮保留)。

**A 范围内**:第一轮就写完的真实版,本轮未修改。

签名严格对齐方案 §3.3 Tool 4:`(attractions, start_point=None, mode="walking") -> str(JSON)`
返回值:排序后的景点列表 + total_distance_km + estimated_minutes + mode
"""
